...
| [`issue-to-eval/`](issue-to-eval/) | **Issue to Eval** | Automatically syncs GitHub issues labeled `benchmark` into the local `evals/` directory. Supports updating existing tests if the issue content changes. |
